...
const Register = () => {
  ...
  const [signup, { isLoading, isSuccess, error, isError, data }] =
    useRegisterUserMutation();

  const handleSignupForm = (user: RegisterInput) => {
    signup(user); 
  };
  ...
  return (
    <div className="container" style={{margin: "auto"}}>
      <form className="form-style1" onSubmit={handleSubmit(handleSignupForm)}>
      <div className="mb25">
      ...
      <div className="mb25">
        <label className="form-label fw600 dark-color">Définissez votre un rôle</label>
          ...
          <option value="" disabled selected>Définisse votre un rôle</option>
